 ...
 * Define blocks with params that will be used in several funcs, so you dont have to rewrite them.
 *
 ...
 * @apiPermission none
 *
 * @apiDescription This func has same errors like POST /user, but errors not defined again, they were included with "apiErrorStructure"
 *
